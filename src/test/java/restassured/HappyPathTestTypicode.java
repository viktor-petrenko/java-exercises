...
import exercises.restassured.typicode.clients.TypiCodeService;
import exercises.restassured.typicode.clients.pojos.EntityInformation;
...
public class HappyPathTestTypicode {
    ...
    public void TestRestAssured() {
        ...
        Response response = given().baseUri("https://jsonplaceholder.typicode.com").when().get("/users");
/**
